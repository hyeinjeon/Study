...
public class TopK {
    ...
    public static class EmpComparator implements Comparator<Emp> {
        public int compare(Emp x, Emp y) { // 내림차순, 오름차순
    ...
    // map 에서 얘 호출
    public static void insertEmp(PriorityQueue q, int id, int salary, String dept_id,
            String emp_info, int topK) {
    ...
    public static class TopKMapper extends Mapper<Object, Text, Text, NullWritable> {
        ...
        private PriorityQueue<Emp> queue = new PriorityQueue<Emp>(10, comp);
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.setInt("topK", topK); // map과 reduce에 전달
